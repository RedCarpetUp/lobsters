namespace :tags_seed do
	...
	task add: :environment do
		new_tags_list = [{ name: "android", description: 	"Android" },
						 ...
						 { name: "ask", description: 	"Ask Lobsters   (hotness mod -0.25)" },
						 ...
						 { name: "culture", description: 	"Technical communities and culture   (hotness mod -0.5)" },
						 ...
						 { name: "meta", description: 	"Lobsters-related bikeshedding   (hotness mod -0.25)" },
						 ...
						 { name: "show", description: 	"Show Lobsters / Projects   (hotness mod +0.25)" },
